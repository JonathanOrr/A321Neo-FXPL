...
function draw()
    ...
    --min max range--
    sasl.gl.drawText(B612_regular, 3 * size[1]/4,   size[2]/2 + 25, "ERROR RANGE", 12, false, false, TEXT_ALIGN_CENTER, blue)
    sasl.gl.drawText(B612_regular, 3 * size[1]/4,   size[2]/2 - 5,  max_error,     28, false, false, TEXT_ALIGN_CENTER, white)

    --integral info--
    sasl.gl.drawText(B612_regular, size[1]/4,       size[2]/2 + 25, "INTEGRAL RANGE",                                        12, false, false, TEXT_ALIGN_CENTER, blue)
    sasl.gl.drawText(B612_regular, size[1]/4,       size[2]/2 - 5,  max_integral,                                            28, false, false, TEXT_ALIGN_CENTER, white)
    sasl.gl.drawText(B612_regular, size[1]/4,       size[2]/2 - 35, "INTEGRAL SUM",                                          12, false, false, TEXT_ALIGN_CENTER, blue)
    sasl.gl.drawText(B612_regular, size[1]/4,       size[2]/2 - 65, string.format("%.2f", tostring(Round(integral_sum, 2))), 28, false, false, TEXT_ALIGN_CENTER, white)
    sasl.gl.drawText(B612_regular, 3* size[1]/4,    size[2]/2 - 35, "INTEGRAL",                                              12, false, false, TEXT_ALIGN_CENTER, blue)
    sasl.gl.drawText(B612_regular, 3* size[1]/4,    size[2]/2 - 65, string.format("%.2f", tostring(Round(integral, 2))),     28, false, false, TEXT_ALIGN_CENTER, white)

    --printing the output
    sasl.gl.drawText(B612_regular, size[1]/2,       size[2]/2 - 95, "THROTTLE RATIO OUTPUT",                                            12, false, false, TEXT_ALIGN_CENTER, blue)
    sasl.gl.drawText(B612_bold,    size[1]/2,       size[2]/2 - 125, string.format("%.4f", tostring(get(A32nx_thrust_control_output))), 28, false, false, TEXT_ALIGN_CENTER, white)
