...
local function draw_pack_indications()
    sasl.gl.drawText(Font_ECAMfont, size[1]/2-304, 140, "PACK 1", 36, true, false, TEXT_ALIGN_CENTER, (get(Pack_L) == 0 and ENG.dyn[1].is_avail) and ECAM_ORANGE or ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, size[1]/2+330, 140, "PACK 2", 36, true, false, TEXT_ALIGN_CENTER, (get(Pack_R) == 0 and ENG.dyn[2].is_avail) and ECAM_ORANGE or ECAM_WHITE)
end
...
local function draw_the_big_grey_box()
    sasl.gl.drawWideLine(214, 237, 214, 253, 3, ECAM_GREY)
    sasl.gl.drawWideLine(214, 253, 114, 253, 3, ECAM_GREY)
    sasl.gl.drawWideLine(114, 253, 114, 499, 3, ECAM_GREY)
    sasl.gl.drawWideLine(114, 499, 793, 499, 3, ECAM_GREY)
    sasl.gl.drawWideLine(793, 499, 793, 472, 3, ECAM_GREY)
    sasl.gl.drawWideLine(793, 420, 804, 420, 3, ECAM_GREY)
    sasl.gl.drawWideLine(808, 357, 794, 357, 3, ECAM_GREY)
    sasl.gl.drawWideLine(794, 253, 794, 357, 3, ECAM_GREY)
    sasl.gl.drawWideLine(794, 253, 701, 253, 3, ECAM_GREY)
    sasl.gl.drawWideLine(590, 253, 474, 253, 3, ECAM_GREY)
    sasl.gl.drawWideLine(474, 253, 474, 238, 3, ECAM_GREY)
    sasl.gl.drawWideLine(411, 243, 411, 253, 3, ECAM_GREY)
    sasl.gl.drawWideLine(411, 253, 276, 253, 3, ECAM_GREY)
    sasl.gl.drawWideLine(276, 253, 276, 243, 3, ECAM_GREY)
end
