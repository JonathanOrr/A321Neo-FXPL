function Update_limit_speeds_module_480x160(x_pos, y_pos, variable_table)
    ...
    if adirs_get_ias(PFD_CAPT) >= get(variable_table.left_values[1]) then
    ...
    elseif adirs_get_ias(PFD_CAPT) < get(variable_table.left_values[1]) and adirs_get_ias(PFD_CAPT) >= get(variable_table.left_values[2]) then
        --lerp the differnce between the difference values
        variable_table.capt_ias_y_pos = Math_lerp(boxes_y_pos[1], boxes_y_pos[2], (get(variable_table.left_values[1]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[1]) - get(variable_table.left_values[2])))
        variable_table.capt_ias_color[1] = Math_lerp(variable_table.left_colors[1][1], variable_table.left_colors[2][1], (get(variable_table.left_values[1]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[1]) - get(variable_table.left_values[2])))
        variable_table.capt_ias_color[2] = Math_lerp(variable_table.left_colors[1][2], variable_table.left_colors[2][2], (get(variable_table.left_values[1]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[1]) - get(variable_table.left_values[2])))
        variable_table.capt_ias_color[3] = Math_lerp(variable_table.left_colors[1][3], variable_table.left_colors[2][3], (get(variable_table.left_values[1]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[1]) - get(variable_table.left_values[2])))
    elseif adirs_get_ias(PFD_CAPT) < get(variable_table.left_values[2]) and adirs_get_ias(PFD_CAPT) >= get(variable_table.left_values[3]) then
        --lerp the differnce between the difference values
        variable_table.capt_ias_y_pos = Math_lerp(boxes_y_pos[2], boxes_y_pos[3], (get(variable_table.left_values[2]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[2]) - get(variable_table.left_values[3])))
        variable_table.capt_ias_color[1] = Math_lerp(variable_table.left_colors[2][1], variable_table.left_colors[3][1], (get(variable_table.left_values[2]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[2]) - get(variable_table.left_values[3])))
        variable_table.capt_ias_color[2] = Math_lerp(variable_table.left_colors[2][2], variable_table.left_colors[3][2], (get(variable_table.left_values[2]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[2]) - get(variable_table.left_values[3])))
        variable_table.capt_ias_color[3] = Math_lerp(variable_table.left_colors[2][3], variable_table.left_colors[3][3], (get(variable_table.left_values[2]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[2]) - get(variable_table.left_values[3])))
    elseif adirs_get_ias(PFD_CAPT) < get(variable_table.left_values[3]) and adirs_get_ias(PFD_CAPT) >= get(variable_table.left_values[4]) then
        --lerp the differnce between the difference values
        variable_table.capt_ias_y_pos = Math_lerp(boxes_y_pos[3], boxes_y_pos[4], (get(variable_table.left_values[3]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[3]) - get(variable_table.left_values[4])))
        variable_table.capt_ias_color[1] = Math_lerp(variable_table.left_colors[3][1], variable_table.left_colors[4][1], (get(variable_table.left_values[3]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[3]) - get(variable_table.left_values[4])))
        variable_table.capt_ias_color[2] = Math_lerp(variable_table.left_colors[3][2], variable_table.left_colors[4][2], (get(variable_table.left_values[3]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[3]) - get(variable_table.left_values[4])))
        variable_table.capt_ias_color[3] = Math_lerp(variable_table.left_colors[3][3], variable_table.left_colors[4][3], (get(variable_table.left_values[3]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[3]) - get(variable_table.left_values[4])))
    elseif adirs_get_ias(PFD_CAPT) < get(variable_table.left_values[4]) and adirs_get_ias(PFD_CAPT) >= get(variable_table.left_values[5]) then
        --lerp the differnce between the difference values
        variable_table.capt_ias_y_pos = Math_lerp(boxes_y_pos[4], boxes_y_pos[5], (get(variable_table.left_values[4]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[4]) - get(variable_table.left_values[5])))
        variable_table.capt_ias_color[1] = Math_lerp(variable_table.left_colors[4][1], variable_table.left_colors[5][1], (get(variable_table.left_values[4]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[4]) - get(variable_table.left_values[5])))
        variable_table.capt_ias_color[2] = Math_lerp(variable_table.left_colors[4][2], variable_table.left_colors[5][2], (get(variable_table.left_values[4]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[4]) - get(variable_table.left_values[5])))
        variable_table.capt_ias_color[3] = Math_lerp(variable_table.left_colors[4][3], variable_table.left_colors[5][3], (get(variable_table.left_values[4]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[4]) - get(variable_table.left_values[5])))
    elseif adirs_get_ias(PFD_CAPT) < get(variable_table.left_values[5]) and adirs_get_ias(PFD_CAPT) >= get(variable_table.left_values[6]) then
        --lerp the differnce between the difference values
        variable_table.capt_ias_y_pos = Math_lerp(boxes_y_pos[5], boxes_y_pos[6], (get(variable_table.left_values[5]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[5]) - get(variable_table.left_values[6])))
        variable_table.capt_ias_color[1] = Math_lerp(variable_table.left_colors[5][1], variable_table.left_colors[6][1], (get(variable_table.left_values[5]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[5]) - get(variable_table.left_values[6])))
        variable_table.capt_ias_color[2] = Math_lerp(variable_table.left_colors[5][2], variable_table.left_colors[6][2], (get(variable_table.left_values[5]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[5]) - get(variable_table.left_values[6])))
        variable_table.capt_ias_color[3] = Math_lerp(variable_table.left_colors[5][3], variable_table.left_colors[6][3], (get(variable_table.left_values[5]) - adirs_get_ias(PFD_CAPT)) / (get(variable_table.left_values[5]) - get(variable_table.left_values[6])))
    elseif adirs_get_ias(PFD_CAPT) < get(variable_table.left_values[6])then
    ...
    --capt ias indications
    if adirs_get_ias(PFD_FO) >= get(variable_table.right_values[1]) then
    ...
    elseif adirs_get_ias(PFD_FO) < get(variable_table.right_values[1]) and adirs_get_ias(PFD_FO) >= get(variable_table.right_values[2]) then
        --lerp the differnce between the difference values
        variable_table.fo_ias_y_pos = Math_lerp(boxes_y_pos[1], boxes_y_pos[2], (get(variable_table.right_values[1]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[1]) - get(variable_table.right_values[2])))
        variable_table.fo_ias_color[1] = Math_lerp(variable_table.right_colors[1][1], variable_table.right_colors[2][1], (get(variable_table.right_values[1]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[1]) - get(variable_table.right_values[2])))
        variable_table.fo_ias_color[2] = Math_lerp(variable_table.right_colors[1][2], variable_table.right_colors[2][2], (get(variable_table.right_values[1]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[1]) - get(variable_table.right_values[2])))
        variable_table.fo_ias_color[3] = Math_lerp(variable_table.right_colors[1][3], variable_table.right_colors[2][3], (get(variable_table.right_values[1]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[1]) - get(variable_table.right_values[2])))
    elseif adirs_get_ias(PFD_FO) < get(variable_table.right_values[2]) and adirs_get_ias(PFD_FO) >= get(variable_table.right_values[3]) then
        --lerp the differnce between the difference values
        variable_table.fo_ias_y_pos = Math_lerp(boxes_y_pos[2], boxes_y_pos[3], (get(variable_table.right_values[2]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[2]) - get(variable_table.right_values[3])))
        variable_table.fo_ias_color[1] = Math_lerp(variable_table.right_colors[2][1], variable_table.right_colors[3][1], (get(variable_table.right_values[2]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[2]) - get(variable_table.right_values[3])))
        variable_table.fo_ias_color[2] = Math_lerp(variable_table.right_colors[2][2], variable_table.right_colors[3][2], (get(variable_table.right_values[2]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[2]) - get(variable_table.right_values[3])))
        variable_table.fo_ias_color[3] = Math_lerp(variable_table.right_colors[2][3], variable_table.right_colors[3][3], (get(variable_table.right_values[2]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[2]) - get(variable_table.right_values[3])))
    elseif adirs_get_ias(PFD_FO) < get(variable_table.right_values[3]) and adirs_get_ias(PFD_FO) >= get(variable_table.right_values[4]) then
        --lerp the differnce between the difference values
        variable_table.fo_ias_y_pos = Math_lerp(boxes_y_pos[3], boxes_y_pos[4], (get(variable_table.right_values[3]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[3]) - get(variable_table.right_values[4])))
        variable_table.fo_ias_color[1] = Math_lerp(variable_table.right_colors[3][1], variable_table.right_colors[4][1], (get(variable_table.right_values[3]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[3]) - get(variable_table.right_values[4])))
        variable_table.fo_ias_color[2] = Math_lerp(variable_table.right_colors[3][2], variable_table.right_colors[4][2], (get(variable_table.right_values[3]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[3]) - get(variable_table.right_values[4])))
        variable_table.fo_ias_color[3] = Math_lerp(variable_table.right_colors[3][3], variable_table.right_colors[4][3], (get(variable_table.right_values[3]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[3]) - get(variable_table.right_values[4])))
    elseif adirs_get_ias(PFD_FO) < get(variable_table.right_values[4]) and adirs_get_ias(PFD_FO) >= get(variable_table.right_values[5]) then
        --lerp the differnce between the difference values
        variable_table.fo_ias_y_pos = Math_lerp(boxes_y_pos[4], boxes_y_pos[5], (get(variable_table.right_values[4]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[4]) - get(variable_table.right_values[5])))
        variable_table.fo_ias_color[1] = Math_lerp(variable_table.right_colors[4][1], variable_table.right_colors[5][1], (get(variable_table.right_values[4]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[4]) - get(variable_table.right_values[5])))
        variable_table.fo_ias_color[2] = Math_lerp(variable_table.right_colors[4][2], variable_table.right_colors[5][2], (get(variable_table.right_values[4]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[4]) - get(variable_table.right_values[5])))
        variable_table.fo_ias_color[3] = Math_lerp(variable_table.right_colors[4][3], variable_table.right_colors[5][3], (get(variable_table.right_values[4]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[4]) - get(variable_table.right_values[5])))
    elseif adirs_get_ias(PFD_FO) < get(variable_table.right_values[5]) and adirs_get_ias(PFD_FO) >= get(variable_table.right_values[6]) then
        --lerp the differnce between the difference values
        variable_table.fo_ias_y_pos = Math_lerp(boxes_y_pos[5], boxes_y_pos[6], (get(variable_table.right_values[5]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[5]) - get(variable_table.right_values[6])))
        variable_table.fo_ias_color[1] = Math_lerp(variable_table.right_colors[5][1], variable_table.right_colors[6][1], (get(variable_table.right_values[5]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[5]) - get(variable_table.right_values[6])))
        variable_table.fo_ias_color[2] = Math_lerp(variable_table.right_colors[5][2], variable_table.right_colors[6][2], (get(variable_table.right_values[5]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[5]) - get(variable_table.right_values[6])))
        variable_table.fo_ias_color[3] = Math_lerp(variable_table.right_colors[5][3], variable_table.right_colors[6][3], (get(variable_table.right_values[5]) - adirs_get_ias(PFD_FO)) / (get(variable_table.right_values[5]) - get(variable_table.right_values[6])))
    elseif adirs_get_ias(PFD_FO) < get(variable_table.right_values[6])then
...
function Draw_limit_speeds_module_480x160(x_pos, y_pos, variable_table)
    ...
    sasl.gl.drawText(B612_MONO_bold, CENTER_X - 70, variable_table.capt_ias_y_pos + 5, math.floor(adirs_get_ias(PFD_CAPT)), 12, false, false, TEXT_ALIGN_CENTER, variable_table.capt_ias_color)
    ...
    sasl.gl.drawText(B612_MONO_bold, CENTER_X + 70, variable_table.fo_ias_y_pos + 5, math.floor(adirs_get_ias(PFD_FO)), 12, false, false, TEXT_ALIGN_CENTER, variable_table.fo_ias_color)

    --limit indications
    if adirs_get_avg_ias() > get(VMAX) then
