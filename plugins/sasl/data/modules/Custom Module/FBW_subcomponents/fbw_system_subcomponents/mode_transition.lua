...
function FBW_mode_transition(table)
    ...
    set(FBW_lateral_ground_mode_ratio, Math_clamp_lower(1 - get(FBW_lateral_flight_mode_ratio), 0))
    set(FBW_vertical_ground_mode_ratio, Math_clamp_lower(1 - get(FBW_vertical_rotation_mode_ratio) - get(FBW_lateral_flight_mode_ratio) - get(FBW_vertical_flare_mode_ratio), 0))
    set(FBW_vertical_flight_mode_ratio, Math_clamp_lower(1 - get(FBW_vertical_rotation_mode_ratio) - get(FBW_vertical_flare_mode_ratio) - get(FBW_vertical_ground_mode_ratio), 0))
end