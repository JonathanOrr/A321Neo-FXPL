...
--view--
Hatswitch_U                   = sasl.findCommand("sim/general/hat_switch_up")
Hatswitch_D                   = sasl.findCommand("sim/general/hat_switch_down")
Hatswitch_L                   = sasl.findCommand("sim/general/hat_switch_left")
Hatswitch_R                   = sasl.findCommand("sim/general/hat_switch_right")
Hatswitch_UL                  = sasl.findCommand("sim/general/hat_switch_up_left")
Hatswitch_UR                  = sasl.findCommand("sim/general/hat_switch_up_right")
Hatswitch_DL                  = sasl.findCommand("sim/general/hat_switch_down_left")
Hatswitch_DR                  = sasl.findCommand("sim/general/hat_switch_down_right")
