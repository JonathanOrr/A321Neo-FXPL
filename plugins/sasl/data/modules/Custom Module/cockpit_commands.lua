...
ND_Capt_mode_cmd_up = sasl.createCommand("a321neo/cockpit/nd/capt_mode_up","")
ND_Capt_mode_cmd_dn = sasl.createCommand("a321neo/cockpit/nd/capt_mode_dn","")
ND_Capt_range_cmd_up = sasl.createCommand("a321neo/cockpit/nd/capt_range_up","")
ND_Capt_range_cmd_dn = sasl.createCommand("a321neo/cockpit/nd/capt_range_dn","")
ND_Capt_nav1_cmd_left = sasl.createCommand("a321neo/cockpit/nd/capt_nav_1_left","")
ND_Capt_nav1_cmd_right = sasl.createCommand("a321neo/cockpit/nd/capt_nav_1_right","")
ND_Capt_nav2_cmd_left = sasl.createCommand("a321neo/cockpit/nd/capt_nav_2_left","")
ND_Capt_nav2_cmd_right = sasl.createCommand("a321neo/cockpit/nd/capt_nav_2_right","")
ND_Capt_cmd_cstr = sasl.createCommand("a321neo/cockpit/nd/capt_pb_cstr","")
ND_Capt_cmd_wpt = sasl.createCommand("a321neo/cockpit/nd/capt_pb_wpt","")
ND_Capt_cmd_vord = sasl.createCommand("a321neo/cockpit/nd/capt_pb_vord","")
ND_Capt_cmd_ndb = sasl.createCommand("a321neo/cockpit/nd/capt_pb_ndb","")
ND_Capt_cmd_arpt = sasl.createCommand("a321neo/cockpit/nd/capt_pb_arpt","")

ND_Fo_mode_cmd_up = sasl.createCommand("a321neo/cockpit/nd/fo_mode_up","")
ND_Fo_mode_cmd_dn = sasl.createCommand("a321neo/cockpit/nd/fo_mode_dn","")
ND_Fo_range_cmd_up = sasl.createCommand("a321neo/cockpit/nd/fo_range_up","")
ND_Fo_range_cmd_dn = sasl.createCommand("a321neo/cockpit/nd/fo_range_dn","")
ND_Fo_nav1_cmd_left = sasl.createCommand("a321neo/cockpit/nd/fo_nav_1_left","")
ND_Fo_nav1_cmd_right = sasl.createCommand("a321neo/cockpit/nd/fo_nav_1_right","")
ND_Fo_nav2_cmd_left = sasl.createCommand("a321neo/cockpit/nd/fo_nav_2_left","")
ND_Fo_nav2_cmd_right = sasl.createCommand("a321neo/cockpit/nd/fo_nav_2_right","")
ND_Fo_cmd_cstr = sasl.createCommand("a321neo/cockpit/nd/fo_pb_cstr","")
ND_Fo_cmd_wpt = sasl.createCommand("a321neo/cockpit/nd/fo_pb_wpt","")
ND_Fo_cmd_vord = sasl.createCommand("a321neo/cockpit/nd/fo_pb_vord","")
...
FCU_Fo_FD_cmd   = sasl.createCommand("a321neo/cockpit/fcu/fo_fd","")
FCU_Fo_LS_cmd   = sasl.createCommand("a321neo/cockpit/fcu/fo_ls","")

FCU_Capt_knob_qnh_dn = sasl.createCommand("a321neo/cockpit/fcu/capt_qnh_dn","")
FCU_Capt_knob_qnh_up = sasl.createCommand("a321neo/cockpit/fcu/capt_qnh_up","")
FCU_Capt_knob_qnh_push = sasl.createCommand("a321neo/cockpit/fcu/capt_qnh_push","")
FCU_Capt_knob_qnh_pull = sasl.createCommand("a321neo/cockpit/fcu/capt_qnh_pull","")
FCU_Capt_knob_qnh_left = sasl.createCommand("a321neo/cockpit/fcu/capt_qnh_left","")
FCU_Capt_knob_qnh_right = sasl.createCommand("a321neo/cockpit/fcu/capt_qnh_right","")
FCU_Fo_knob_qnh_dn = sasl.createCommand("a321neo/cockpit/fcu/fo_qnh_dn","")
FCU_Fo_knob_qnh_up = sasl.createCommand("a321neo/cockpit/fcu/fo_qnh_up","")
FCU_Fo_knob_qnh_push = sasl.createCommand("a321neo/cockpit/fcu/fo_qnh_push","")
FCU_Fo_knob_qnh_pull = sasl.createCommand("a321neo/cockpit/fcu/fo_qnh_pull","")
FCU_Fo_knob_qnh_left = sasl.createCommand("a321neo/cockpit/fcu/fo_qnh_left","")
FCU_Fo_knob_qnh_right = sasl.createCommand("a321neo/cockpit/fcu/fo_qnh_right","")

FCU_knob_speed_up   = sasl.createCommand("a321neo/cockpit/fcu/spd_knob_up","")
FCU_knob_speed_dn   = sasl.createCommand("a321neo/cockpit/fcu/spd_knob_dn","")
FCU_knob_speed_pull = sasl.createCommand("a321neo/cockpit/fcu/spd_knob_pull","")
FCU_knob_speed_push = sasl.createCommand("a321neo/cockpit/fcu/spd_knob_push","")

FCU_knob_hdg_up   = sasl.createCommand("a321neo/cockpit/fcu/hdg_knob_up","")
FCU_knob_hdg_dn   = sasl.createCommand("a321neo/cockpit/fcu/hdg_knob_dn","")
FCU_knob_hdg_pull = sasl.createCommand("a321neo/cockpit/fcu/hdg_knob_pull","")
FCU_knob_hdg_push = sasl.createCommand("a321neo/cockpit/fcu/hdg_knob_push","")

FCU_knob_vs_up   = sasl.createCommand("a321neo/cockpit/fcu/vs_knob_up","")
FCU_knob_vs_dn   = sasl.createCommand("a321neo/cockpit/fcu/vs_knob_dn","")
FCU_knob_vs_pull = sasl.createCommand("a321neo/cockpit/fcu/vs_knob_pull","")
FCU_knob_vs_push = sasl.createCommand("a321neo/cockpit/fcu/vs_knob_push","")

FCU_knob_alt_up   = sasl.createCommand("a321neo/cockpit/fcu/alt_knob_up","")
FCU_knob_alt_dn   = sasl.createCommand("a321neo/cockpit/fcu/alt_knob_dn","")
FCU_knob_alt_pull = sasl.createCommand("a321neo/cockpit/fcu/alt_knob_pull","")
FCU_knob_alt_push = sasl.createCommand("a321neo/cockpit/fcu/alt_knob_push","")
FCU_knob_range_toggle = sasl.createCommand("a321neo/cockpit/fcu/alt_knob_range_toggle","")

FCU_cmd_spd_mach = sasl.createCommand("a321neo/cockpit/fcu/spd_mach","")
FCU_cmd_hdg_trk = sasl.createCommand("a321neo/cockpit/fcu/hdg_trk","")
FCU_cmd_metric_alt = sasl.createCommand("a321neo/cockpit/fcu/metric_alt","")

FCU_cmd_pb_loc   = sasl.createCommand("a321neo/cockpit/fcu/pb_loc","")
FCU_cmd_pb_ap_1  = sasl.createCommand("a321neo/cockpit/fcu/pb_ap_1","")
FCU_cmd_pb_ap_2  = sasl.createCommand("a321neo/cockpit/fcu/pb_ap_2","")
FCU_cmd_pb_athr  = sasl.createCommand("a321neo/cockpit/fcu/pb_athr","")
FCU_cmd_pb_exped = sasl.createCommand("a321neo/cockpit/fcu/pb_exped","")
...
Chrono_cmd_date_dn     = sasl.createCommand("a321neo/cockpit/misc/chrono_date_dn","")
