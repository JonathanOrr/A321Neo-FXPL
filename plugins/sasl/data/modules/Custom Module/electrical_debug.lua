...
function draw()
    ...
    print_bool(10,  size[2]-360, "Conn. to bus", ELEC_sys.generators[1].is_connected_to_ac_bus)
    print_bool(200, size[2]-360, "Conn. to bus", ELEC_sys.generators[2].is_connected_to_ac_bus)
    print_bool(390, size[2]-510, "Conn. to bus", ELEC_sys.generators[3].is_connected_to_ac_bus)
    print_bool(10,  size[2]-510, "Conn. to bus", ELEC_sys.generators[4].is_connected_to_ac_bus)
    print_bool(200, size[2]-510, "Conn. to bus", ELEC_sys.generators[5].is_connected_to_ac_bus)
   
    sasl.gl.drawFrame(5, size[2]-370, 170, 130, ECAM_WHITE)
    sasl.gl.drawFrame(195, size[2]-370, 170, 130, ECAM_WHITE)
    sasl.gl.drawFrame(385, size[2]-520, 170, 130, ECAM_WHITE)
    sasl.gl.drawFrame(5, size[2]-520, 170, 130, ECAM_WHITE)
    sasl.gl.drawFrame(195, size[2]-520, 170, 130, ECAM_WHITE)
