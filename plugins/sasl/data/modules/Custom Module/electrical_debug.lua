...
function draw()
    ...
    -- Generators status
    sasl.gl.drawText(B612MONO_regular, 10, size[2]-270, "Generator 1", 15, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(B612MONO_regular, 200, size[2]-270,"Generator 2", 15, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
...
--    print_bus_source(200, 480, size[2]-570, "DC 1 BUS pwrd by: ", ELEC_sys.buses.dc_1_powered_by)
    ...
    print_value_dec(580,  size[2]-330, "COMMERCIAL (A)", ELEC_sys.buses.pwr_consumption_last[ELEC_BUS_COMMERCIAL])
