...
function draw()
    ...
    if manual_switching_in_progress == 0 then
        ...
        sasl.gl.drawText(B612MONO_bold, size[1]/2 - 150, size[2]/2 + 27, "PFD", 19.5, false, false, TEXT_ALIGN_CENTER, capt_pfd_text_color)
        --Capt ND--
        sasl.gl.drawRectangle(size[1]/2 - 100, size[2]/2 + 10, 50, 50, capt_nd_color)
        sasl.gl.drawText(B612MONO_bold, size[1]/2 - 75, size[2]/2 + 27, "ND", 19.5, false, false, TEXT_ALIGN_CENTER, capt_nd_text_color)
        --EWD--
        sasl.gl.drawRectangle(size[1]/2 - 25, size[2]/2 + 10, 50, 50, ewd_color)
        sasl.gl.drawText(B612MONO_bold, size[1]/2, size[2]/2 + 27, "EWD", 19.5, false, false, TEXT_ALIGN_CENTER, ewd_text_color)
        --FO ND--
        sasl.gl.drawRectangle(size[1]/2 + 50, size[2]/2 + 10, 50, 50, fo_nd_color)
        sasl.gl.drawText(B612MONO_bold, size[1]/2 + 75, size[2]/2 + 27, "ND", 19.5, false, false, TEXT_ALIGN_CENTER, fo_nd_text_color)
        --FO PFD--
        sasl.gl.drawRectangle(size[1]/2 + 125, size[2]/2 + 10, 50, 50, fo_pfd_color)
        sasl.gl.drawText(B612MONO_bold, size[1]/2 + 150, size[2]/2 + 27, "PFD", 19.5, false, false, TEXT_ALIGN_CENTER, fo_pfd_text_color)
        --ECAM--
        sasl.gl.drawRectangle(size[1]/2 - 25, size[2]/2 - 65, 50, 50, ecam_color)
        sasl.gl.drawText(B612MONO_bold, size[1]/2, size[2]/2 - 48, "ECAM", 19.5, false, false, TEXT_ALIGN_CENTER, ecam_text_color)
    else
