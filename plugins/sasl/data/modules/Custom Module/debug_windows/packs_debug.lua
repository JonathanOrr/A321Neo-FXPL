...
local function draw_xplane_part()
    ...
    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 - size[1]/4, 520, "X-PLANE PACKS", 15,false, false, TEXT_ALIGN_CENTER, ECAM_BLUE)
    --direct bleed feeds--


    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 - size[1]/4 - 100, size[2]/2-150, "ENG 1 BLEED", 10,false, false, TEXT_ALIGN_CENTER, eng_1_bleed_cl)
    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 - size[1]/4      , size[2]/2-150, "APU BLEED", 10,false, false, TEXT_ALIGN_CENTER, apugpu_bleed_cl)
    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 - size[1]/4      , size[2]/2-170, "GPU BLEED", 10,false, false, TEXT_ALIGN_CENTER, get(Gpu_bleed_switch) == 1 and ECAM_GREEN or ECAM_ORANGE)
    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 - size[1]/4 + 100, size[2]/2-150, "ENG 2 BLEED", 10,false, false, TEXT_ALIGN_CENTER, eng_2_bleed_cl)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 - size[1]/4 - 100, size[2]/2+120, "L PACK", 10,false, false, TEXT_ALIGN_CENTER, left_pack_cl)
    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 - size[1]/4      , size[2]/2+120, "M PACK", 10,false, false, TEXT_ALIGN_CENTER, mid_pack_cl)
    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 - size[1]/4 + 100, size[2]/2+120, "R PACK", 10,false, false, TEXT_ALIGN_CENTER, right_pack_cl)
end
...
local function draw_a32nx_part()
    ...
    sasl.gl.drawText(Font_B612MONO_regular, size[1]/2 + size[1]/4, 520, "A32NX PACKS", 15,false, false, TEXT_ALIGN_CENTER, ECAM_BLUE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+90 , 30, "HP", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawLine(width_start+100, 40, width_start+130, 40, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+135, 40, "HYD\nRSVR", 8, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_end-90 , 30, "HP", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 275, "TEMP", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 265, math.ceil(get(L_bleed_temp)) .. " C", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 250, "PRESS", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 240, math.ceil(get(L_bleed_press)) .. " PSI", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)

    sasl.gl.drawText(Font_B612MONO_regular, width_end-60, 290, "BLEED R", 10, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawFrame(width_end-60, 235, 50, 50, UI_DARK_BLUE)
    sasl.gl.drawLine(width_end-50, 200, width_end-50, 235, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 275, "TEMP", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 265, math.ceil(get(R_bleed_temp)) .. " C", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 250, "PRESS", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 240, math.ceil(get(R_bleed_press)) .. " PSI", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)

    -- main bleed lined
    sasl.gl.drawText(Font_B612MONO_regular, (width_end+width_start)/2, 180, "X BLEED", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+150, 75, "APU", 10, false, false, TEXT_ALIGN_CENTER, get(Apu_avail) == 0 and ECAM_ORANGE or ECAM_GREEN)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+100, 135, "GND\nAIR", 10, false, false, TEXT_ALIGN_CENTER, get(GAS_bleed_avail) == 0 and ECAM_ORANGE or ECAM_GREEN)

    -- APU BLEED
    sasl.gl.drawText(Font_B612MONO_regular, width_start+175, 135, "APU BLEED", 10, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+185, 120, "PRESS", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+185, 110, math.ceil(get(Apu_bleed_psi)) .. " PSI", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)    

    -- top lines
    sasl.gl.drawLine(width_start+80, 200, width_start+80, 220,ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+80, 235, " WING\nA. ICE", 8, false, false, TEXT_ALIGN_CENTER, get(AI_wing_L_operating) == 1 and ECAM_GREEN or ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+140, 227, "CARGO", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawLine(width_end-80, 200, width_end-80, 220,ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-80, 235, " WING\nA. ICE", 8, false, false, TEXT_ALIGN_CENTER, get(AI_wing_R_operating) == 1 and ECAM_GREEN or ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+170, 255, "HYD\nRSVR", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-170, 255, "WATER\nTANKS", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    
    -- PACKS
    draw_valve_v(width_start+120, 260, get(Pack_L) == 1)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+95, 270, "PACK 1", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawLine(width_start+120, 200, width_start+120, 250, ECAM_WHITE)
    draw_valve_v(width_end-120, 260, get(Pack_R) == 1)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-95, 270, "PACK 2", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, (width_end+width_start)/2, 355, "MIXER", 12, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, (width_end+width_start)/2+75, 357, math.floor(get(Aircond_mixer_temp)) .. " C", 8, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular,width_start+170, 325, "RAM\nAIR", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+130, 405, "CKPT", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, (width_end+width_start)/2, 405, "FWD", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-130, 405, "AFT", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_end-138, 315, "HOT\nAIR", 8, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-130, 330, math.floor(get(Hot_air_temp)).. " C", 8, false, false, TEXT_ALIGN_RIGHT, UI_LIGHT_RED)
    ...
    -- Pack temp & airflow
    sasl.gl.drawText(Font_B612MONO_regular, width_start+10, 400, "PACK 1", 10, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawFrame(width_start+10, 320, 55, 75, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 385, "OUT TEMP", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 375, math.ceil(get(L_pack_temp)) .. " C", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 360, "FLOW", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 350, flow_to_text(L_pack_Flow), 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 335, "CMP TEMP", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 325, math.ceil(get(L_compressor_temp)) .. " C", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawLine(width_start+65, 330, width_start+120, 330, UI_DARK_BLUE)
    
    -- Pack temp & airflow
    sasl.gl.drawText(Font_B612MONO_regular, width_end-60, 400, "PACK 2", 10, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawFrame(width_end-60, 320, 55, 75, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 385, "OUT TEMP", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 375, math.ceil(get(R_pack_temp)) .. " C", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 360, "FLOW", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 350, flow_to_text(R_pack_Flow), 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 335, "CMP TEMP", 9, false, false, TEXT_ALIGN_LEFT, UI_DARK_BLUE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-55, 325, math.ceil(get(R_compressor_temp)) .. " C", 9, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawLine(width_end-60, 330, width_end-120, 330, UI_DARK_BLUE)
    
    -- Cargo
    sasl.gl.drawFrame(width_start+30, 440, 100, 60, ECAM_MAGENTA)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+100, 505, "CARGO", 12, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+105, 455, "C.HOT\nAIR", 9, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+70, 465, math.floor(get(Hot_air_temp_cargo)).. " C", 8, false, false, TEXT_ALIGN_RIGHT, UI_LIGHT_RED)
    ...
    sasl.gl.drawText(Font_B612MONO_regular, width_start+80, 480, "MIX", 9, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+15, 495, "INLET", 9, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_start+150, 495, "OUTLET", 9, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)

    -- Temperature table
    sasl.gl.drawText(Font_B612MONO_regular, width_end-165, 485, "CKPT", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-165, 470, "FWD", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-165, 455, "AFT", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-165, 430, "CARGO", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-120, 500, "SP", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-75, 500, "ACTUAL", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-30, 500, "INFLOW", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    
    sasl.gl.drawText(Font_B612MONO_regular, width_end-120, 485, math.floor(get(Cockpit_temp_req)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_GREEN)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-75, 485, math.floor(get(Cockpit_temp)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_GREEN)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-30, 485, math.floor(get(Aircond_injected_flow_temp,1)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, {1,1,0})
    
    sasl.gl.drawText(Font_B612MONO_regular, width_end-120, 470, math.floor(get(Front_cab_temp_req)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_GREEN)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-75, 470, math.floor(get(Front_cab_temp)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_GREEN)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-30, 470, math.floor(get(Aircond_injected_flow_temp,2)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, {1,1,0})
    
    sasl.gl.drawText(Font_B612MONO_regular, width_end-120, 455, math.floor(get(Aft_cab_temp_req)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_GREEN)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-75, 455, math.floor(get(Aft_cab_temp)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_GREEN)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-30, 455, math.floor(get(Aircond_injected_flow_temp,3)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, {1,1,0})
    
    sasl.gl.drawText(Font_B612MONO_regular, width_end-120, 430, math.floor(get(Aft_cargo_temp_req)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_GREEN)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-75, 430, math.floor(get(Aft_cargo_temp)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, ECAM_GREEN)
    sasl.gl.drawText(Font_B612MONO_regular, width_end-30, 430, math.floor(get(Aircond_injected_flow_temp,4)) .. " C", 9, false, false, TEXT_ALIGN_RIGHT, {1,1,0})
