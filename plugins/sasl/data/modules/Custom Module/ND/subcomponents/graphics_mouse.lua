...
local function draw_menu(data)
    ...
    if data.plan_mouse_menu_visible and data.plan_mouse_menu_x ~= nil then
        ...
        sasl.gl.drawText(Font_ECAMfont, x+10, y-40, "ADD CROSS", 28, true, false, TEXT_ALIGN_LEFT, color)
        sasl.gl.drawText(Font_ECAMfont, x+10, y-80, "ADD FLAG", 28, true, false, TEXT_ALIGN_LEFT, color)
        sasl.gl.drawText(Font_ECAMfont, x+10, y-120, "ERASE ALL CROSSES", 28, true, false, TEXT_ALIGN_LEFT, color)
        sasl.gl.drawText(Font_ECAMfont, x+10, y-160, "ERASE ALL FLAGS", 28, true, false, TEXT_ALIGN_LEFT, color)
        ...
        sasl.gl.drawText(Font_ECAMfont, x+10, y-200, "CENTER ON ACFT", 28, true, false, TEXT_ALIGN_LEFT, color)
