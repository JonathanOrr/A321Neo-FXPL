...
-------------------------------------------------------------------------------
local Sounds_GPWS_5_feet = sasl.createCommand("a321neo/sounds/gpws/feet_5", "Internal use only. DO NOT USE.")
local Sounds_GPWS_10_feet = sasl.createCommand("a321neo/sounds/gpws/feet_10", "Internal use only. DO NOT USE.")
local Sounds_GPWS_20_feet = sasl.createCommand("a321neo/sounds/gpws/feet_20", "Internal use only. DO NOT USE.")
local Sounds_GPWS_30_feet = sasl.createCommand("a321neo/sounds/gpws/feet_30", "Internal use only. DO NOT USE.")
local Sounds_GPWS_40_feet = sasl.createCommand("a321neo/sounds/gpws/feet_40", "Internal use only. DO NOT USE.")
local Sounds_GPWS_50_feet = sasl.createCommand("a321neo/sounds/gpws/feet_50", "Internal use only. DO NOT USE.")
local Sounds_GPWS_100_feet = sasl.createCommand("a321neo/sounds/gpws/feet_100", "Internal use only. DO NOT USE.")
local Sounds_GPWS_200_feet = sasl.createCommand("a321neo/sounds/gpws/feet_200", "Internal use only. DO NOT USE.")
local Sounds_GPWS_300_feet = sasl.createCommand("a321neo/sounds/gpws/feet_300", "Internal use only. DO NOT USE.")
local Sounds_GPWS_400_feet = sasl.createCommand("a321neo/sounds/gpws/feet_400", "Internal use only. DO NOT USE.")
local Sounds_GPWS_500_feet = sasl.createCommand("a321neo/sounds/gpws/feet_500", "Internal use only. DO NOT USE.")
local Sounds_GPWS_1000_feet = sasl.createCommand("a321neo/sounds/gpws/feet_1000", "Internal use only. DO NOT USE.")
local Sounds_GPWS_2000_feet = sasl.createCommand("a321neo/sounds/gpws/feet_2000", "Internal use only. DO NOT USE.")
local Sounds_GPWS_2500_feet = sasl.createCommand("a321neo/sounds/gpws/feet_2500", "Internal use only. DO NOT USE.")
local Sounds_GPWS_retard = sasl.createCommand("a321neo/sounds/gpws/retard", "Internal use only. DO NOT USE.")
local Sounds_GPWS_retard_retard = sasl.createCommand("a321neo/sounds/gpws/retardretard", "Internal use only. DO NOT USE.")

local Sounds_GPWS_100Above = sasl.createCommand("a321neo/sounds/gpws/100Above", "Internal use only. DO NOT USE.")
local Sounds_GPWS_Minimum = sasl.createCommand("a321neo/sounds/gpws/Minimum", "Internal use only. DO NOT USE.")

local Sounds_GPWS_dontsink = sasl.createCommand("a321neo/sounds/gpws/dontsink", "Internal use only. DO NOT USE.")
local Sounds_GPWS_glideslope = sasl.createCommand("a321neo/sounds/gpws/glideslope", "Internal use only. DO NOT USE.")
local Sounds_GPWS_glideslope_hard = sasl.createCommand("a321neo/sounds/gpws/glideslope_hard", "Internal use only. DO NOT USE.")
local Sounds_GPWS_inop = sasl.createCommand("a321neo/sounds/gpws/gpws_inop", "Internal use only. DO NOT USE.")
local Sounds_GPWS_terr_inop = sasl.createCommand("a321neo/sounds/gpws/terrain_inop", "Internal use only. DO NOT USE.")
local Sounds_GPWS_obsahead = sasl.createCommand("a321neo/sounds/gpws/obsahead", "Internal use only. DO NOT USE.")
local Sounds_GPWS_obsaheadpull = sasl.createCommand("a321neo/sounds/gpws/obsaheadpull", "Internal use only. DO NOT USE.")
local Sounds_GPWS_pullup = sasl.createCommand("a321neo/sounds/gpws/pullup", "Internal use only. DO NOT USE.")
local Sounds_GPWS_sinkrate = sasl.createCommand("a321neo/sounds/gpws/sinkrate", "Internal use only. DO NOT USE.")
local Sounds_GPWS_terr = sasl.createCommand("a321neo/sounds/gpws/terr", "Internal use only. DO NOT USE.")
local Sounds_GPWS_terrahead = sasl.createCommand("a321neo/sounds/gpws/terrahead", "Internal use only. DO NOT USE.")
local Sounds_GPWS_terrterr = sasl.createCommand("a321neo/sounds/gpws/terrterr", "Internal use only. DO NOT USE.")
local Sounds_GPWS_terraheadpull = sasl.createCommand("a321neo/sounds/gpws/terraheadpull", "Internal use only. DO NOT USE.")
local Sounds_GPWS_tlflaps = sasl.createCommand("a321neo/sounds/gpws/tlflaps", "Internal use only. DO NOT USE.")
local Sounds_GPWS_tlgear = sasl.createCommand("a321neo/sounds/gpws/tlgear", "Internal use only. DO NOT USE.")
local Sounds_GPWS_tlterr = sasl.createCommand("a321neo/sounds/gpws/tlterr", "Internal use only. DO NOT USE.")

local Sounds_GPWS_pitch = sasl.createCommand("a321neo/sounds/gpws/pitch", "Internal use only. DO NOT USE.")
local Sounds_GPWS_windshear = sasl.createCommand("a321neo/sounds/gpws/windshear", "Internal use only. DO NOT USE.")
local Sounds_GPWS_speed = sasl.createCommand("a321neo/sounds/gpws/speed", "Internal use only. DO NOT USE.")

local Sounds_GPWS_dual_input = sasl.createCommand("a321neo/sounds/gpws/dual_input", "Internal use only. DO NOT USE.")
local Sounds_GPWS_priority_left = sasl.createCommand("a321neo/sounds/gpws/priority_left", "Internal use only. DO NOT USE.")
local Sounds_GPWS_priority_right = sasl.createCommand("a321neo/sounds/gpws/priority_right", "Internal use only. DO NOT USE.")

local Sounds_alt_callout   = createGlobalPropertyi("a321neo/sounds/alt_callout", 0, false, true, false)

local Sounds_GPWS_test_start = sasl.createCommand("a321neo/sounds/gpws/test_start", "Internal use only. DO NOT USE.")
local Sounds_GPWS_test_pass  = sasl.createCommand("a321neo/sounds/gpws/test_pass", "Internal use only. DO NOT USE.")
local Sounds_GPWS_test_end   = sasl.createCommand("a321neo/sounds/gpws/test_end", "Internal use only. DO NOT USE.")
