...
local function draw_menu_item_right(line, text, color)
    ...
    sasl.gl.drawText(Font_ECAMfont, x-29, y-10, text, 25, false, false, TEXT_ALIGN_RIGHT, color)
...
local function draw_menu_item_left(line, text, color)
    ...
    local x = 10
    local y = size[2] - ((line-1) * 100)-46
    sasl.gl.drawText(Font_ECAMfont, x+29, y-10, text, 25, false, false, TEXT_ALIGN_LEFT, color)
...
local function draw_tcas_fixed_indication()
    sasl.gl.drawText(Font_ECAMfont, 230, 70, "TCAS", 22, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
...
local function draw_page_vhf(data)
    ...
    sasl.gl.drawText(Font_ECAMfont, size[1]/2+40,size[2]-55, "VHF1", 45, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, size[1]/2+40,size[2]-155, "VHF2", 45, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, size[1]/2+40,size[2]-255, "VHF3", 45, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
...
local function draw_page_hf(data)
    ...
    sasl.gl.drawText(Font_ECAMfont, size[1]/2+40,size[2]-55, "HF1", 45, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, size[1]/2+40,size[2]-155, "HF2", 45, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)
end
...
local function draw_page_tel(data)
    ...
    sasl.gl.drawText(Font_ECAMfont, 140,size[2]-55, "TEL1", 45, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, 140,size[2]-85, "CPNY", 22, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, 140,size[2]-155, "TEL2", 45, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, 140,size[2]-185, "CPNY", 22, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)

    sasl.gl.drawText(Font_ECAMfont, 20,size[2]-45, "DIAL", 25, false, false, TEXT_ALIGN_LEFT, ECAM_BLUE)
    sasl.gl.drawText(Font_ECAMfont, 20,size[2]-145, "DIAL", 25, false, false, TEXT_ALIGN_LEFT, ECAM_BLUE)
...
local function draw_page_atc(data)
    ...
    sasl.gl.drawText(Font_ECAMfont, 20,size[2]-35, "ATC", 25, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, 20,size[2]-135, "ATC MODE", 25, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, 20,size[2]-265, "IDENT", 40, false, false, TEXT_ALIGN_LEFT, ECAM_BLUE)

    sasl.gl.drawText(Font_ECAMfont, size[1]-20,size[2]-35, "TCAS MODE", 25, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, size[1]-20,size[2]-135, "TCAS DISPLAY MODE", 25, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, size[1]-20,size[2]-235, "ALT RPTG", 25, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
...
local function draw_page_nav(data)
    ...
    sasl.gl.drawText(Font_ECAMfont, size[1]/2,size[2]-40, "RAD NAV", 25, false, false, TEXT_ALIGN_CENTER, ECAM_WHITE)


    sasl.gl.drawText(Font_ECAMfont, size[1]-20,size[2]-335, "AUDIO NAV", 25, false, false, TEXT_ALIGN_RIGHT, ECAM_WHITE)
    sasl.gl.drawText(Font_ECAMfont, 20,size[2]-335, "VOICE", 25, false, false, TEXT_ALIGN_LEFT, ECAM_WHITE)
