function Draw_flight_control_module_480x160(x_pos, y_pos)
    ...
    sasl.gl.drawWideLine(CENTER_X - 65,  y_pos + 160 - 158 + 50, CENTER_X - 65,  y_pos + 160 - 158 + 50 + get(L_SPLR_1), 5, FBW.fctl.surfaces.splr.L[1].controlled and LIGHT_BLUE or ORANGE)
    sasl.gl.drawWideLine(CENTER_X - 95,  y_pos + 160 - 158 + 52, CENTER_X - 95,  y_pos + 160 - 158 + 52 + get(L_SPLR_2), 5, FBW.fctl.surfaces.splr.L[2].controlled and LIGHT_BLUE or ORANGE)
    sasl.gl.drawWideLine(CENTER_X - 115, y_pos + 160 - 158 + 54, CENTER_X - 115, y_pos + 160 - 158 + 54 + get(L_SPLR_3), 5, FBW.fctl.surfaces.splr.L[3].controlled and LIGHT_BLUE or ORANGE)
    sasl.gl.drawWideLine(CENTER_X - 135, y_pos + 160 - 158 + 56, CENTER_X - 135, y_pos + 160 - 158 + 56 + get(L_SPLR_4), 5, FBW.fctl.surfaces.splr.L[4].controlled and LIGHT_BLUE or ORANGE)
    sasl.gl.drawWideLine(CENTER_X - 155, y_pos + 160 - 158 + 58, CENTER_X - 155, y_pos + 160 - 158 + 58 + get(L_SPLR_5), 5, FBW.fctl.surfaces.splr.L[5].controlled and LIGHT_BLUE or ORANGE)

    sasl.gl.drawWideLine(CENTER_X + 65,  y_pos + 160 - 158 + 50, CENTER_X + 65,  y_pos + 160 - 158 + 50 + get(R_SPLR_1), 5, FBW.fctl.surfaces.splr.R[1].controlled and LIGHT_BLUE or ORANGE)
    sasl.gl.drawWideLine(CENTER_X + 95,  y_pos + 160 - 158 + 52, CENTER_X + 95,  y_pos + 160 - 158 + 52 + get(R_SPLR_2), 5, FBW.fctl.surfaces.splr.R[2].controlled and LIGHT_BLUE or ORANGE)
    sasl.gl.drawWideLine(CENTER_X + 115, y_pos + 160 - 158 + 54, CENTER_X + 115, y_pos + 160 - 158 + 54 + get(R_SPLR_3), 5, FBW.fctl.surfaces.splr.R[3].controlled and LIGHT_BLUE or ORANGE)
    sasl.gl.drawWideLine(CENTER_X + 135, y_pos + 160 - 158 + 56, CENTER_X + 135, y_pos + 160 - 158 + 56 + get(R_SPLR_4), 5, FBW.fctl.surfaces.splr.R[4].controlled and LIGHT_BLUE or ORANGE)
    sasl.gl.drawWideLine(CENTER_X + 155, y_pos + 160 - 158 + 58, CENTER_X + 155, y_pos + 160 - 158 + 58 + get(R_SPLR_5), 5, FBW.fctl.surfaces.splr.R[5].controlled and LIGHT_BLUE or ORANGE)
