FBW.fctl.surfaces.THS = {}
FBW.fctl.surfaces.THS.motor = {
    [1] = {
        avail = true,
...
FBW.fctl.surfaces.THS.THS = {
    ...
    last_ELAC_1_STAT = 0,
    motor = {
        FBW.fctl.surfaces.THS.motor[1],
        FBW.fctl.surfaces.THS.motor[2],
        FBW.fctl.surfaces.THS.motor[3],
    },
    hyd_sys = {
        Hydraulic_G_press,
        Hydraulic_Y_press,
    ...
    computer_priority = {
        {ELAC_2_status, FBW.fctl.surfaces.THS.motor[1]},
        {ELAC_1_status, FBW.fctl.surfaces.THS.motor[2]},
        {SEC_2_status,  FBW.fctl.surfaces.THS.motor[3]},
        {SEC_1_status,  FBW.fctl.surfaces.THS.motor[2]},
    }
}

FBW.fctl.status.THS_MOTOR = function (fctl_table)
...
FBW.fctl.status.THS = function (THS_table, ELEV_table)
...
FBW.fctl.status.THS_REST = function (THS_table, THS_POS_DATAREF)
...
function update()
    FBW.fctl.status.THS_MOTOR(FBW.fctl.surfaces.THS.motor)
    FBW.fctl.status.THS(FBW.fctl.surfaces.THS.THS, FBW.fctl.surfaces.elev)
    FBW.fctl.status.THS_REST(FBW.fctl.surfaces.THS.THS, Augmented_pitch_trim_ratio)
end