...
local failures_data = {
    ...
    },
    {
        ...
        failures={
            ...
            {name="FMGC 1\nFAIL", status=false, dataref=FAILURE_FMGC_1 },
            {name="FMGC 2\nFAIL", status=false, dataref=FAILURE_FMGC_2 }
        }
    },
    {
        group="ELECTRICAL",
    ...
    },
    {
        ...
        failures={
            ...
            {name="ENG 1 OIL\nLEAK", status=false, dataref=FAILURE_ENG_LEAK_OIL, nr=1 },
            {name="ENG 2 OIL\nLEAK", status=false, dataref=FAILURE_ENG_LEAK_OIL, nr=2 },
            {name="ENG 1 OIL\nHI TEMP", status=false, dataref=FAILURE_ENG_OIL_HI_TEMP, nr=1 },
            {name="ENG 2 OIL\nHI TEMP", status=false, dataref=FAILURE_ENG_OIL_HI_TEMP, nr=2 },
            {name="ENG 1 COMP.\nVANE FAIL", status=false, dataref=FAILURE_ENG_COMP_VANE, nr=1 },
            {name="ENG 2 COMP.\nVANE FAIL", status=false, dataref=FAILURE_ENG_COMP_VANE, nr=2 },
            {name="ENG 1 SYS\nFAULT", status=false, dataref=FAILURE_ENG_SYS_FAULT, nr=1 },
            {name="ENG 2 SYS\nFAULT", status=false, dataref=FAILURE_ENG_SYS_FAULT, nr=2 },
    ...
    },
    {
        ...
        failures={
            ...
            {name="CABIN HOTAIR\nREG FAIL", status=false, dataref=FAILURE_AIRCOND_HOT_AIR_REG_FAIL },
            {name="CARGO HOTAIR\nVLV STUCK", status=false, dataref=FAILURE_AIRCOND_HOT_AIR_CARGO_STUCK },
            {name="CARGO HOTAIR\nREG FAIL", status=false, dataref=FAILURE_AIRCOND_HOT_AIR_CARGO_REG_FAIL },
