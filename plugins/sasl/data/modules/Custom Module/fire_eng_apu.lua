...
local function update_pbs()
    ...
    pb_set(PB.ped.eng_1_fire_fault, ENG.dyn[1].is_failed, FIRE_sys.eng[1].still_on_fire or FIRE_sys.eng[1].on_test)
    pb_set(PB.ped.eng_2_fire_fault, ENG.dyn[2].is_failed, FIRE_sys.eng[2].still_on_fire or FIRE_sys.eng[2].on_test)
