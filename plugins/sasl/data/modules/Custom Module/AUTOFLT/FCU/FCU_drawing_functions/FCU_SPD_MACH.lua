...
local function draw_spd_mach_value()
    ...
    local spd_mach_value = get(AUTOFLT_FCU_SPD_or_MACH) == 0 and Fwd_string_fill(tostring(get(AUTOFLT_FCU_SPD)), "0", 3) or Fwd_string_fill(tostring(Round(get(AUTOFLT_FCU_MACH) * 100)), "0", 3)
