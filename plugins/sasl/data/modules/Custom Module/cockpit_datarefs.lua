...
NAV_2_freq_hz = globalProperty("sim/cockpit2/radios/actuators/nav2_frequency_hz")
...
AUTOFLT_FCU_SPD             = createGlobalPropertyf("a321neo/cockpit/AUTOFLT/FCU/speed", 100, false, true, false)
AUTOFLT_FCU_MACH            = createGlobalPropertyf("a321neo/cockpit/AUTOFLT/FCU/mach", 0.1, false, true, false)
AUTOFLT_FCU_HDG_TRK         = createGlobalPropertyf("a321neo/cockpit/AUTOFLT/FCU/heading_track", 0, false, true, false)
AUTOFLT_FCU_ALT             = createGlobalPropertyf("a321neo/cockpit/AUTOFLT/FCU/altitude", 0, false, true, false)
AUTOFLT_FCU_VS              = createGlobalPropertyf("a321neo/cockpit/AUTOFLT/FCU/vertical_speed", 0, false, true, false)
